...
(function () {
  ...
  const STRINGS = {
    ko: {
      ...
      library: '목록',
      newScore: '새 악보',
      newScoreTitle: '새 악보 만들기',
      newScoreMessage: '새로운 악보를 만들 수 있어요.',
      open: '불러오기',
      delete: '삭제',
      ...
      installProgress: '설치 중...',
      installSuccessTitle: '설치되었습니다',
      installSuccessMessage: '브라우저를 닫고, 홈 화면의 MukeBox 아이콘을 눌러 실행해 주세요.',
      installContinue: '이대로 계속하기',
      installApp: 'App 설치',
      installReinstallTitle: '바로가기 다시 추가하기',
      installReinstallIntro: '앱은 설치되어 있지만 홈 화면 아이콘이 없을 수 있어요.',
      installReinstallChrome: 'Chrome <strong>메뉴(⋮)</strong> → <strong>앱 설치</strong> 또는 <strong>홈 화면에 추가</strong>를 선택하세요.',
      installReinstallApps: '설치된 앱 목록(<code>chrome://apps</code>)에서 MukeBox를 찾아 실행하거나 바로가기를 만들 수 있어요.',
      language: '언어',
      meter: '박자',
      selectMeter: '박자 선택',
      tempo: '템포',
    ...
    en: {
      ...
      library: 'List',
      newScore: 'New score',
      newScoreTitle: 'New Score',
      newScoreMessage: 'Create a brand-new score.',
      open: 'Open',
      delete: 'Delete',
      ...
      installSuccessMessage: 'Close the browser and open MukeBox from your home screen.',
      installContinue: 'Continue here',
      installApp: 'Install app',
      installReinstallTitle: 'Re-add shortcut',
      installReinstallIntro: 'The app may still be installed even if the home screen icon is missing.',
      installReinstallChrome: 'In Chrome, open the <strong>menu (⋮)</strong> → <strong>Install app</strong> or <strong>Add to Home screen</strong>.',
      installReinstallApps: 'Find MukeBox in installed apps (<code>chrome://apps</code>) to open it or create a shortcut.',
      language: 'Language',
      meter: 'Meter',
